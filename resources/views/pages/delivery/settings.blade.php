            ...
            <div class="ms-3 grow">
                <div id="vertical-tab-with-border-1" role="tabpanel" aria-labelledby="vertical-tab-with-border-item-1">
                    <div class="lg:grid grid-cols-5">
                        <form action="{{ route('delivery.settings.account') }}" method="post" class="mt-5 col-span-2"
                            autocomplete="off">
                            @method('PUT')
                            @csrf
                ...
                <div id="vertical-tab-with-border-2" class="hidden" role="tabpanel"
                    ...
                    <div class="lg:grid grid-cols-5">
                        <form action="{{ route('delivery.settings.password') }}" method="post" class="mt-5 col-span-2"
                            autocomplete="off">
                            @method('PUT')
                            @csrf
