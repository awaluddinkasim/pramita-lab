    ...
    <div class="grid lg:grid-cols-2 gap-4">
        ...
        <section id="formPengiriman">
            <div class="card">
                ...
                <form method="post" action="{{ route('admin.order.update', $order) }}" autocomplete="off">
                    @method('PUT')
                    @csrf

                    <div class="mb-3">
                        <label for="userSelect" class="block text-sm font-medium mb-2">Pengirim</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="tujuanInput" name="tujuan"
                            ...
                            placeholder="Masukkan tujuan" value="{{ $order->tujuan }}" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea id="detailInput" name="detail"
                            ...
                            rows="5" placeholder="Masukkan detail pengiriman" required>{{ $order->detail }}</textarea>
                    </div>
