...
bg-gray-800 border-e border-gray-600"
    ...
    <div class="relative flex flex-col h-full max-h-full ">
        ...
        <!-- Footer -->
        <footer class="mt-auto p-2 border-t border-gray-600">
            <!-- Account Dropdown -->
            <div class="hs-dropdown [--strategy:absolute] [--auto-close:inside] relative w-full inline-flex">
                <button id="hs-sidebar-footer-example-with-dropdown" type="button"
                    class="w-full inline-flex shrink-0 items-center gap-x-2 p-2 text-start text-sm text-white rounded-md hover:bg-gray-700 focus:outline-hidden focus:bg-blue-400"
